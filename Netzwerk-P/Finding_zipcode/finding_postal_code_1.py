...
zipCode = pd.read_excel('DE.xlsx')
#zipCode.columns = ['Country', 'Zip_Code', 'City', 'State', 'State_Code', 'NaN', 'Zeros', 'District','NUmber', 'lati','logi', '4']
#zipCode = zipCode.drop(['NaN',''Zeros'','4'], axis=1)
