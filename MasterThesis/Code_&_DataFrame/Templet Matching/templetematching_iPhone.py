...
''' ########################## Iphone Templet ################# '''
iphone = imread('temp_img/40-II.jpg')

#iphone = imread('pos_blitz.jpg')
#plt.figure()
#imshow(iphone)

iphone = rgb2gray(iphone)
iphone_temp = iphone[450:2250,1017:1195]
#iphone_temp = iphone[1300:2500,1705:1905]
#plt.figure()
#imshow(iphone_temp)
...
#            crop_img_BM = crop_img_BM[200:890,:]
