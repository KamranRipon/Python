...
''' ######################### Imager Templet ################## '''
immg = imread('temp_img/Dig 40 nM.tif')
immg = rgb2gray(immg)

imager_temp = immg[600:1550,1542:1639]
#plt.figure()
#imshow(imager_temp)
#plt.yticks(range(0,imager_temp.shape[0],100), fontsize=20)
#plt.xticks(range(0,imager_temp.shape[1],50), fontsize=20)
#plt.title('Serum Digoxygenin 40 nM/L', fontsize=20)


#data_dir = ('../../Dataset Gold-NP-LFA/IMAGES GOLD-DIGOXIGENIN-LFA/Data Serum/14-11-2018 Dig Serum BioImager/DIG-Serum III/')
...
#for img in ['Serum 40 nmol_Dig_I.tif']:
